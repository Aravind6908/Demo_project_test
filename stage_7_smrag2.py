...
if uploaded_file:
    ...
    #   rag_summary = rag_query_response(
    #   prompt="Provide a comprehensive and structured summary of this legal document, focusing on the facts, arguments, judgment, and timeline of events.",
    #   embedding_text=embedding_text )
        ...
        st.info(f"⏱️ RAG-based summary generated in **{processing_time} minutes**.")

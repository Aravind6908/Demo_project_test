...
@st.cache_resource
def load_led():
    tokenizer = LEDTokenizer.from_pretrained("allenai/led-base-16384", use_auth_token=HF_API_TOKEN)
    model = LEDForConditionalGeneration.from_pretrained("allenai/led-base-16384", use_auth_token=HF_API_TOKEN)
